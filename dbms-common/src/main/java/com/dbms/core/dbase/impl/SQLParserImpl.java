...
public class SQLParserImpl implements ISQLParser {
    ...
    @Override
    public SqlTypeEnum getSqlType(String sql) throws JSQLParserException {
...
//            System.out.println(sqlStmt.getClass());
     ...
     * @return
     */
    public List<String> getTableList(String sql, SqlTypeEnum sqlTypeEnum) throws JSQLParserException {
    ...
    @Override
    public Set<String> getSchemas(String sql, SqlTypeEnum sqlTypeEnum) throws JSQLParserException {
...
//                break;
     ...
     */
    @Override
    public HashMap<String,String> getTableMap(String sql, SqlTypeEnum sqlTypeEnum) throws JSQLParserException {
...
//                break;
    ...
    public HashMap<String, ArrayList<String>> getTableColumnList(String sql, SqlTypeEnum sqlTypeEnum) throws JSQLParserException {
                        ...
                        if (selectItem instanceof SelectExpressionItem) {
                            ...
                            if (value instanceof Column) {
                                ...
                                if(str.length == 1){
                                    ...
                                    String currentTableName = replace(tableList.get(0));
                                ...
                                if(tableNameMap != null) str[0] = tableNameMap;
//                                System.out.println(mapList.getOrDefault(str[0], null));
                                if(!(mapList.containsKey(str[0]))){
                                    mapList.put(str[0], new ArrayList<String>());
                                }
                                mapList.get(str[0]).add(str[1]);;
     ...
     */
    @Override
    public HashMap<String, ArrayList<Map<String, String>>> getTableColumnMap(String sql, SqlTypeEnum sqlTypeEnum) throws JSQLParserException {
        List<String> columnList = new ArrayList<>();
        HashMap<String, String> tableMap = getTableMap(sql, sqlTypeEnum);
        TablesNamesFinder tablesNamesFinder = new TablesNamesFinder();
