...
public interface ISysUserService
{
     ...
     * @return 用户信息集合信息
     */
    public List<UserEntity> selectAllocatedList(UserEntity user);
     ...
     * @return 用户信息集合信息
     */
    public List<UserEntity> selectUnallocatedList(UserEntity user);
     ...
     * @param user 用户信息
     */
    public void checkUserAllowed(UserEntity user);
     ...
     * @return 结果
     */
    public int resetPwd(UserEntity user);
     ...
     * @return 结果
     */
    public String importUser(List<UserEntity> userList, Boolean isUpdateSupport, String operName);
}
